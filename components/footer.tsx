    ...
    <footer className="bg-[rgb(8_37_70)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="font-display text-2xl font-bold text-[rgb(120_218_210)] mb-4">East Coast Boat Removal</h3>
            ...
            <div className="rounded-[1.4rem] border border-white/10 bg-[rgb(255_255_255/0.06)] p-4">
              ...
              <a href="tel:+15614040669" className="mt-2 block font-display text-2xl font-bold text-white transition-colors hover:text-[rgb(150_228_222)]">
                (561) 404-0669
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-white/68 hover:text-[rgb(150_228_222)] transition-colors text-sm"
                >
                  Home
                </Link>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white font-bold hover:text-[rgb(150_228_222)] transition-colors"
                  >
                    (561) 404-0669
                  </a>
                </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-end gap-6 text-sm">
              <Link href="/#contact" className="text-white/56 transition-colors hover:text-[rgb(150_228_222)]">
                Contact Us
              </Link>
              <Link href="/#services" className="text-white/56 transition-colors hover:text-[rgb(150_228_222)]">
                Services
              </Link>
              <Link href="/#service-areas" className="text-white/56 transition-colors hover:text-[rgb(150_228_222)]">
                Coverage
              </Link>
            </div>
          </div>
